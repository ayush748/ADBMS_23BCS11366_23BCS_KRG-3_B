-- Create table to hold actual NPV values
...
-- Create table for query requests
...
-- Final Query: Return requested (ID, YEAR) with their corresponding NPV if available, else 0
SELECT 
    Q.ID,
    Q.YEAR,
